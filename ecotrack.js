        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ display: this.state.welcomePageDisplay }}>
                    ...
                    <Image source={{ uri: 'https://static.vecteezy.com/system/resources/thumbnails/007/634/526/small/environment-logo-icon-design-template-free-vector.jpg' }}style={{ height: 140, width: 200 }}/>
                ...
                <View style={{ display: this.state.infoPageDisplay }}>
                    <View style={styles.contentContainer}>
                        <Text style={styles.paragraph}>
                            This page should contain information on new environmental issues.
                        </Text>
                    </View>
                </View>
                ...
                <View style={{ display: this.state.feedbackPageDisplay }}>
                    ...
                    <TouchableHighlight style={styles.navButton}onPress={this.loginProtocol}>
                        ...
                        <Text style={styles.paragraph}>
                            Enter your opinion on the environment in cambodia here!
                        </Text>
                    </View>
                </View>
