        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{ display: this.state.welcomePageDisplay }}>
                    ...
                    <Image source={{ uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Peace_symbol_%28bold%29.svg/170px-Peace_symbol_%28bold%29.svg.png' }}style={{ height: 140, width: 200 }}/>
                ...
                <View style={{ display: this.state.infoPageDisplay }}>
                    <View style={styles.contentContainer}>
                        <Text style={styles.paragraph}>
                            This page should contain protest and rallies information.
                        </Text>
                    </View>
                </View>
